...
namespace Gst {
	...
	public class Memory : Gst.MiniObject {
		...
		public void unmap (Gst.MapInfo info);
		[CCode (has_construct_function = false)]
		public Memory.wrapped (Gst.MemoryFlags flags, [CCode (array_length_cname = "maxsize", array_length_pos = 2.33333, array_length_type = "gsize")] uint8[] data, size_t offset, size_t size, void * user_data, [CCode (delegate_target_pos = 4.66667)] GLib.DestroyNotify? notify);
	}
