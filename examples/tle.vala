...
"""
{
  "created_at" : "Sat Jun 14 12:15:18 +0000 2014",
  "id" : 477786356329234433,
  "id_str" : "477786356329234433",
  "text" : "OMG! https://t.co/OOwbJTApub",
  "source" : "<a href=\"http://twitter.com\" rel=\"nofollow\">Twitter Web Client</a>",
  "truncated" : false,
  "in_reply_to_status_id" : null,
  "in_reply_to_status_id_str" : null,
...
void main (string[] args) {
  Settings.init ();
  Twitter.get ().init ();
  var account = new Account (1234, "foobar", "Foo Bar");
  ...
  tweet.load_from_json (root_node, now, account);
  ...
  var entry = new TweetListEntry (tweet, null, account);
  list.add (entry);
